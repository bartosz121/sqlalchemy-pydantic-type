...
Welcome to the contributor guide of SQLAlchemy Pydantic Type.
...
If you experience bugs or general issues with SQLAlchemy Pydantic Type, please have a look
...
You can help improve the documentation of SQLAlchemy Pydantic Type by making them more readable
...
3. Clone this copy to your local disk:
   ...
   ```console
   git clone git@github.com:YourLogin/sqlalchemy-pydantic-type.git
   cd sqlalchemy-pydantic-type
   ```
...
5. Please check that your changes don't break any unit tests with `hatch run test_containerized`
